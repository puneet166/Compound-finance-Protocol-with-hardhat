...
import { BlockExplorerApiKeyClient, DeploymentClient, DeploymentConfigClient, UpgradeClient } from '@openzeppelin/platform-deploy-client';
...
export declare function getDefenderClient(hre: HardhatRuntimeEnvironment): DefenderClient;
/**
