...
function warnOnHardhatDefender() {
    if (tryRequire('@openzeppelin/hardhat-defender', true)) {
        (0, upgrades_core_1.logWarning)('The @openzeppelin/hardhat-defender package is deprecated.', [
...
function makeFunctions(hre, defender) {
    ...
    return {
        ...
        deployProxyAdmin: (0, deploy_proxy_admin_1.makeDeployProxyAdmin)(hre, defender),
